...
if add_publisher_sales:
    ...
    title = "Region-wise sales for " + heading5 + " (in millions)"
    ...
    charts[title] = [chart5, conclusion_card_0]


if add_genre_sales:
    heading6 = st.selectbox("Choose a genre (for pie chart)", data['Genre'].unique(), key=98)

    title2 = "Region-wise sales for " + heading6 + " (in millions)"
...
if add_platform_sales:
    ...
    charts[title3] = [chart7, conclusion_card_2]


if add_year_sales:
    heading8 = st.selectbox("Choose a year (for pie chart)", [int(i) for i in data['Year'].unique()], key=96)

    title4 = "Region-wise sales in " + str(heading8) + " (in millions)"
    ...
    charts[title4] = [chart8, conclusion_card_3]
